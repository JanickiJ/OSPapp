...
#define DATE "built on: Sun May 16 22:19:50 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','a','g','u','t',
    '/','D','e','s','k','t','o','p','/','O','S','P','A','P','P','/',
    'O','S','P','a','p','p','/','.','b','u','i','l','d','o','z','e',
    'r','/','a','n','d','r','o','i','d','/','p','l','a','t','f','o',
    'r','m','/','b','u','i','l','d','-','a','r','m','e','a','b','i',
    '-','v','7','a','/','b','u','i','l','d','/','p','y','t','h','o',
    'n','-','i','n','s','t','a','l','l','s','/','o','s','p','a','p',
    'p','/','i','n','c','l','u','d','e','/','p','y','t','h','o','n',
    '3','.','8','\0'
};
