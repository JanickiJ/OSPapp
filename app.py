...
from screen_helpers.sing_in_screen_string import sing_in_helper
from screen_helpers.sing_up_screen_string import sign_up_helper
...
class OSPApp(MDApp):
    ...
    def build(self):
        ...
        self.log_in_screen = Builder.load_string(sing_in_helper)
